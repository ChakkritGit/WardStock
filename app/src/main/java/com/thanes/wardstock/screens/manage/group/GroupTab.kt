  ...
  Scaffold(
    ...
    floatingActionButton = {
      ExtendedFloatingActionButton(
        onClick = { navController.navigate(Routes.AddGroup.route) },
    ...
    Box(
      ...
      when {
        ...
        groupSharedViewModel.groupInventoryState.isEmpty() -> {
          ...
          val filteredList = groupSharedViewModel.groupInventoryState.filter {
            it.drugname.toString().contains(searchText, ignoreCase = true)
          }
